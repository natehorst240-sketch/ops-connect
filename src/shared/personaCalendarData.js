...
//
// All dates are expressed relative to DEMO_TODAY_ISO via the d(n) helper so
// the calendar stays aligned with OpsScheduleBoard and ClinicalStaffingBoard.
// ============================================================================

import { DEMO_TODAY_ISO } from '../data/mxOncallSchedule';

// d(n) — ISO date n days offset from DEMO_TODAY_ISO
function d(n) {
  const date = new Date(DEMO_TODAY_ISO + 'T12:00:00Z');
...
const ALL_EVENTS = [
  ...
  { id: 'insp-8', date: d(5), type: 'inspection',
  ...
  { id: 'insp-9', date: d(6), type: 'inspection',
  ...
  { id: 'cs-na-1', date: d(0), type: 'crew_shift',
  ...
  { id: 'os-4', date: d(8), type: 'open_shift',
  ...
  { id: 'cert-1', date: '2026-06-12', type: 'cert_exp',
    title: 'M. Bryce · PALS expires', detail: 'Renewal 25 days out',
    crew: 'M. Bryce', region: '109 UT', priority: 'normal' },
  { id: 'cert-2', date: d(12), type: 'cert_exp',
    title: 'R. Linsler · PALS expires', detail: 'Renewal 12 days out',
    crew: 'R. Linsler', region: '109 UT', priority: 'high' },

  // ===== Audit / approval events (for QA) =====
  { id: 'ap-1', date: d(0), type: 'approval',
    title: 'MX approval · N39KM', detail: 'RMM approved',
    region: 'WY/MT', priority: 'normal' },
  { id: 'ap-2', date: d(0), type: 'approval',
